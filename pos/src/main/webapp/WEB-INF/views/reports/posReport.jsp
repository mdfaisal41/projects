...
<div class="row">
	...
	<div class="col-lg-12">
		...
		<form class="form-horizontal form-bordered" action="viewreport"
			...
			<section class="panel panel-featured panel-featured-primary">
				<header class="panel-heading">
					<h2 class="panel-title">POS Report</h2>
				</header>
						...
						<div class="col-sm-6 form-group">
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="input-group">
									...
									</span> <input type="hidden" name="reportCode" value="102"> <input
