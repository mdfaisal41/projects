						...
						<div class="col-sm-6 form-group">
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="input-group">
									...
									</span> <input type="hidden" name="reportCode" value="201">
										<input type="text" data-plugin-datepicker id="fromDate"
										name="fromDate" class="form-control mandatory" value="" required>
								</div>
							</div>
						</div>
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="input-group">
									<span class="input-group-addon"> <i
										...
										name="toDate" class="form-control mandatory" value="" required>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12">
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-5 col-sm-3 control-label">Item
									Name</label>
								<div class="col-md-7 col-sm-7 col-xs-12">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-5 col-sm-3 control-label" for="vehicleClassId">Product
									Name</label>
								<div class="col-md-7 col-sm-7 col-xs-12">
							...
							<table
								...
								<thead>
									<tr style="border-style: inset;">
										...
										<th style="border-style: inset;">Wastage Name</th>
