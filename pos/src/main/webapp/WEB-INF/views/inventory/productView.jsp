...
<header class="page-header">
	...
	<div class="left-wrapper pull-left">
		<ol class="breadcrumbs">
			...
			<li><span>Inventory View</span></li>
		</ol>
	</div>
			...
			<div class="col-lg-12">
				...
				<div class="panel-body">
					<div class="col-lg-12">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-6 control-label" for="vehicleClassId">Product
									Name</label>
								<div class="col-md-6">
									<select data-plugin-selectTwo class="form-control"
							...
							<table
								...
								<thead>
									<tr style="border-style: inset;">
										...
										<th style="border-style: inset;">Product Name</th>
										<th style="border-style: inset;">Date</th>
										<th style="border-style: inset;">Price</th>
										<th style="border-style: inset;">Employee</th>
