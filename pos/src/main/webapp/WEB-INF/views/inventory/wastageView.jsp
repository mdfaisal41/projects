			...
			<div class="col-lg-12">
				<header class="panel-heading">
					<div class="panel-actions">
						<a href="/pos/inventory/wastage"><button
								class="btn btn-primary btn-round" type="button">
								<span><i class="fa fa-plus"></i> Add New Wastage</span>
							</button></a>
					</div>
					<h2 class="panel-title">Wastage List View</h2>
				</header>
				...
				<div class="panel-body">
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="input-group">
									<span class="input-group-addon"> <i
										...
										type="text" data-plugin-datepicker id="fromDate" placeholder="dd/mm/yyyy"
										name="fromDate" class="form-control mandatory" value="${inventory.fromDate}"
										required>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 form-group">
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="input-group">
									<span class="input-group-addon"> <i
										class="fa fa-calendar"></i>
									</span> <input type="text" data-plugin-datepicker id="toDate" placeholder="dd/mm/yyyy"
										name="toDate" class="form-control mandatory" value="${inventory.toDate}" required>
								</div>
							</div>
						</div>
								...
								<div class="col-md-7 col-sm-7 col-xs-12">
									<select data-plugin-selectTwo class="form-control" id="itemId"
										...
										<c:forEach items="${itemList}" var="list">
											<option <c:if test="${list.itemId==inventory.itemId}">selected="selected"</c:if>
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-md-5 col-sm-3 control-label"
									for="vehicleClassId">Ingredient Name</label>
								<div class="col-md-7 col-sm-7 col-xs-12">
					...
					<div class="col-lg-12">
						<div class="col-sm-5 col-sm-offset-0">
							...
							<a href="/pos/inventory/wastageView">
								<button class="btn btn-sm btn  btn-default"
									type="button"> <i class="fa fa-refresh"> </i> Clear</button>
							</a>
						</div>
					</div>
				</div>
				...
				<div class=" panel-body">
					...
					<p
						<c:if test="${empty oWastageViewListSize}">
					style="display: none"
					</c:if>>
						Total Record Found : <strong><span style="color: red">${oWastageViewListSize}</span></strong>
							...
							<table
								...
								<thead>
									<tr style="border-style: inset;">
										...
										<th style="border-style: inset;">Item</th>
										<th style="border-style: inset;">Ingredients</th>
										<th style="border-style: inset;">Quantity</th>
										<th style="border-style: inset;">Unit</th>
										<th style="border-style: inset;">Price</th>
								...
								<tbody id="classOneStudentList">
									<c:if test="${!empty wastageViewList}">
										<%
											int i = 1;
										%>
										<c:forEach items="${wastageViewList}" var="list">
									...
									<c:if test="${! empty wastageViewListNotFound}">
										<tr>
											<td colspan="6"><p>${wastageViewListNotFound}</p></td>
										</tr>
									</c:if>
								</tbody>
							</table>
...
<script>
	function getWastageInfo(encWastageId) {
		//alert(encStudentId);
		var url = "/pos/inventory/getWastageInfo?encWastageId="
				+ encodeURIComponent(encWastageId);
		//alert(url);
		window.location = url;
	}
